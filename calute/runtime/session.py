...
Usage::
    ...
    from calute.runtime.session import RuntimeSession
...
class RuntimeSession:
    ...
    def create(
        ...
        **metadata: Any,
        ...
        from calute.llms.registry import detect_provider
    ...
    def save(self, directory: str | Path = ".calute_sessions") -> Path:
        ...
        data = {
            ...
            "stream_events": self.stream_events[:100],  # Limit for size
