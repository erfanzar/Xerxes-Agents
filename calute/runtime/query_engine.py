...
Usage::
    ...
    from calute.runtime.query_engine import QueryEngine, QueryEngineConfig
...
class QueryEngine:
    ...
    def submit(
        ...
        # Run the streaming agent loop and collect results
        from calute.streaming.events import AgentState, TextChunk, ToolEnd, ToolStart, TurnDone
        ...
        for event in run(
            ...
            if isinstance(event, TextChunk):
                ...
                pass  # Already logged in ToolStart
        ...
        # Sync transcript with agent state messages
    ...
    def submit_stream(
        ...
        """
        from calute.streaming.events import AgentState, TextChunk, ToolStart, TurnDone
        from calute.streaming.loop import run
