...
Compares the current Calute module set against a reference surface
...
Usage::
    ...
    from calute.runtime.parity_audit import run_parity_audit
...
# Expected modules in the Calute framework
...
def run_parity_audit(
    ...
    """Run a parity audit of the Calute package.

    Args:
        package_root: Root path of the calute package.
    ...
    # Find extra modules not in reference
