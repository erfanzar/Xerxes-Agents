...
images, within the Calute framework. It includes functions for downloading,
...
Example:
    >>> from calute.multimodal import download_image, SerializableImage
    >>>
...
Example:
    >>> from pydantic import BaseModel
    >>> from calute.multimodal import SerializableImage
    >>>
