...
# Global sub-agent manager (lazily initialized)
_agent_manager = None
...
class AskUserQuestionTool(AgentBaseFn):
    ...
    def static_call(
        ...
        **context_variables,
        ...
        """
        # In non-interactive contexts, return a placeholder
        # The TUI/CLI should intercept this tool and handle it via UI
...
class LSPTool(AgentBaseFn):
    ...
    def static_call(
        ...
        **context_variables,
        ...
        """
        # LSP requires an active server connection — return a helpful message
        return (
    ...
    def static_call(
        ...
        **context_variables,
        ...
        try:
            ...
            # MCP requires async initialization — return guidance
            return (
