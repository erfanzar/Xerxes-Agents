...
Usage::
    ...
    from calute.llms.registry import detect_provider, get_provider_config, calc_cost

    provider = detect_provider("deepseek-chat")   # → "deepseek"
    config   = get_provider_config("deepseek")     # → ProviderConfig(...)
...
PROVIDERS: dict[str, ProviderConfig] = {
    ...
    "custom": ProviderConfig(
        ...
        base_url=None,  # must be provided via config
        context_limit=128_000,
        models=[],
    ),
}
