...
class UniversalAgent(CortexAgent):
    ...
    - DuckDuckGoSearch: Web searching and information gathering
    ...
    def _build_tool_set(self, additional_tools: list[Any] | None = None) -> list[Any]:
        ...
        Returns:
            ...
            both class-based tools (DuckDuckGoSearch, WriteFile, ExecutePythonCode)
...
class UniversalTaskCreator:
    ...
    Example:
        ...
        # Tasks related to security go to security_agent
        # Tasks related to database go to database_agent
        # All other tasks go to universal_agent
    """
