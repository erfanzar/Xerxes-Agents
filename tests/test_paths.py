...
"""Tests for XERXES_HOME env override in xerxes_agent.core.paths."""
...
import pytest
from xerxes_agent.core.paths import XERXES_HOME_ENV, xerxes_home, xerxes_subdir
...
@pytest.mark.parametrize(
    "module_attr",
    [
        ("xerxes_agent.daemon.config", "DAEMON_DIR"),
        ("xerxes_agent.bridge.profiles", "PROFILES_DIR"),
    ],
)
