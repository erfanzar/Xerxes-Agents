...
class TestCompactProfile:
    ...
    def test_truncates_skill_instructions(self):
        ...
        # The full section text for the skill would be longer than 500.
        # It should be truncated and end with "..."
        assert "..." in prefix
        # The truncated content should not contain the full 2000 A's
...
class TestTruncation:
    def test_skill_instruction_exact_limit(self):
        ...
        registry = SkillRegistry()
        # We need to account for the header that to_prompt_section adds
        skill = Skill(
