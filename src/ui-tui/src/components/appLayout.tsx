import { AlternateScreen, Box, NoSelect, ScrollBox, Text } from '@xerxes/ink'
...
import { LiveAgentPanel, LiveTodoPanel, StreamingAssistant } from './streamingAssistant.js'
import { TextInput, type TextInputMouseApi } from './textInput.js'
import type { SessionInfo } from '../types.js'

const initialProjectDir = (): string => process.env.XERXES_PROJECT_DIR || process.env.XERXES_CWD || process.cwd()

const startupInfo = (): SessionInfo => ({
  cwd: initialProjectDir(),
  lazy: true,
  model: '',
  skills: {},
  tools: {}
            ...
            <Box flexDirection="column" key={row.key} ref={transcript.virtualHistory.measureRef(row.key)}>
              ...
              {row.msg.kind === 'intro' ? (
                <Box flexDirection="column" paddingTop={1}>
                  ...
                  <SessionPanel
                    info={row.msg.info ?? ui.info ?? startupInfo()}
