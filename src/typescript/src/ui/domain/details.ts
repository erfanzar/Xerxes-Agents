...
//   - subagents: retained as a config compatibility key, but the OpenTUI
//     transcript ignores it because spawn trees live in /agents and the
//     persistent wide-terminal agent rail.
//
