...
**License warning:** OBLITERATUS is AGPL-3.0. NEVER import it as a library. Always invoke it through an explicitly configured external CLI boundary. This keeps Xerxes' Apache-2.0 runtime separate from the AGPL implementation.
