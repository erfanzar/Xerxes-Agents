...
This skill operates only in a user-provided workspace whose external Manim, LaTeX, and ffmpeg tools are already configured. Xerxes does not install, probe, or launch setup helpers for those tools. Reference docs target Manim CE v0.20.1.
