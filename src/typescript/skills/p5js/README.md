...
| **MP4** | Browser-created frame sequence + user-owned ffmpeg |
| **SVG** | p5.js-svg renderer for vector output |

## Prerequisites

A modern browser. Optional video encoding requires an ffmpeg installation the user explicitly supplies. Xerxes does not ship launchers, start a browser or server, or disable browser sandboxing.
...
│   ├── export-pipeline.md       # PNG, GIF, MP4, SVG, tiling, and browser-native export
