...
Xerxes links to venue-owned sources instead of redistributing their template files. Always check
the current year and track before preparing a submission.
...
| Author and formatting instructions 2025 | [NeurIPS](https://neurips.cc/Conferences/2025/CallForPapers) | Official format and template requirements |

### ICML

| Document | URL | Purpose |
|----------|-----|---------|
| Author Instructions 2026 | [ICML](https://icml.cc/Conferences/2026/AuthorInstructions) | Official style files and submission requirements |
| Reviewer Instructions 2026 | [ICML](https://icml.cc/Conferences/2026/ReviewerInstructions) | Review form, evaluation |
...
| Document | URL | Purpose |
|----------|-----|---------|
| Submission Instructions and Author Kit 2026 | [AAAI](https://aaai.org/conference/aaai/aaai-26/submission-instructions/) | Official templates and guidelines |
