...
Conference templates are not redistributed with Xerxes. Download the exact year and track from
the venue immediately before starting or converting a submission:

- [NeurIPS 2025 Call for Papers and formatting instructions](https://neurips.cc/Conferences/2025/CallForPapers)
...
- [AAAI-26 Submission Instructions and Author Kit](https://aaai.org/conference/aaai/aaai-26/submission-instructions/)
- [COLM official template repository](https://github.com/COLM-org/Template)

Retain the downloaded archive's license or usage notice, extract the complete archive, and treat
venue-owned style and bibliography files as read-only unless the current instructions explicitly
permit changes.
