...
metadata:
  xerxes:
    ...
    related_skills: [claude-code, xerxes-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Xerxes terminal. Codex is OpenAI's autonomous coding agent CLI.
