...
COMMAND_REGISTRY: tuple[CommandDef, ...] = (
    ...
    CommandDef("model", "List provider models or switch model", "config", args_hint="[provider:model]"),
    ...
    CommandDef("reasoning", "Show/set thinking effort (off|low|medium|high)", "config", aliases=("thinking",), args_hint="[level]"),
    ...
    CommandDef("init", "Ask the agent to inspect and initialize project context", "tools"),
