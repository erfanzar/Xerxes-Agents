...
version: 0.1.0
tags: [ReadFile, GrepTool, exec_command]
required_tools: [ReadFile, GrepTool, exec_command]
---
# When to use
...
5. **exec_command** — cmd=cat /Users/erfan/.xerxes/sk...
6. **ReadFile** — file_path=/Users/erfan/.xerxes/skills...

# Verification

After running the procedure, the agent should have invoked these tools in order: `ReadFile>GrepTool>GrepTool>GrepTool>exec_command>ReadFile`.
