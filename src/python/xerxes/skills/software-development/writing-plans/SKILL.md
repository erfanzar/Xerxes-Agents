...
version: 1.1.0
author: Xerxes Agent (adapted from obra/superpowers)
license: MIT
metadata:
  xerxes:
...
> **for Xerxes:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Xerxes tools to understand the project:
