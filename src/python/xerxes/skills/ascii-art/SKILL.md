...
```bash
python3 -m pyfiglet "Xerxes" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=Xerxes&font=Slant" | boxes -d stone
```
