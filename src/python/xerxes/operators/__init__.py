...
"""Operator tooling for Xerxes runtime.

This package provides the operator subsystem that powers interactive,
long-running tool execution within Xerxes.  It includes:
...
sub-managers and exposes callable operator tools to the Xerxes runtime.
"""
