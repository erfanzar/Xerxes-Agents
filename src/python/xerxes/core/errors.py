...
"""Custom error types for better error handling in Xerxes.

This module defines a hierarchy of exception classes for precise error
handling throughout the Xerxes framework. All exceptions inherit from
XerxesError and provide detailed error information including context
...
class XerxesError(Exception):
    ...
    This is the root exception class for the Xerxes framework.
