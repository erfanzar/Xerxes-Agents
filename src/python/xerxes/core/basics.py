...
"""Basic utilities and registration system for Xerxes components.

This module provides a registration system for tracking and managing
different Xerxes components including clients, agents, and xerxes instances.
...
def basic_registry(
    ...
    Args:
        register_type: The type of component to register ('xerxes', 'agents', or 'client').
    ...
    Example:
        >>> @basic_registry("agents", "my_agent")
        ... class MyAgent:
