...
def _build_system_prompt(context: dict[str, Any], extra: str = "") -> str:
    ...
    parts = [
        ...
        "exec_command, write_stdin, list_terminal_sessions, close_terminal_session, apply_patch, ExecuteShell,",
        ...
        "   Use ExecuteShell(command=...) only for short blocking one-shot commands.",
