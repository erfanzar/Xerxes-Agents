...
- Optional Python entry-point discovery via the ``xerxes_agent.channels``
  group (``pyproject.toml`` :code:`[project.entry-points."xerxes_agent.channels"]`).
"""
...
class ChannelRegistry:
    ...
    def discover_entry_points(self, group: str = "xerxes_agent.channels") -> list[str]:
