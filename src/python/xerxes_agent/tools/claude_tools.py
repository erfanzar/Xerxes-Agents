        ...
        **context_variables,
        ...
        try:
            ...
            return (
                ...
                "Use xerxes_agent.mcp.MCPManager for async MCP tool invocation. "
                "This tool is a placeholder for the synchronous tool interface."
            )
        except ImportError:
            return "Error: xerxes_agent.mcp module not available. Install xerxes[mcp]."
...
class ListMcpResourcesTool(AgentBaseFn):
    ...
    def static_call(server_name: str = "", **context_variables) -> str:
        ...
        return (
            ...
            "Use xerxes_agent.mcp.MCPManager.list_resources() for async MCP resource listing."
        )
    ...
    def static_call(
        ...
        **context_variables,
        ...
        return (
            ...
            "Use xerxes_agent.mcp.MCPManager.read_resource() for async MCP resource reading."
        )
