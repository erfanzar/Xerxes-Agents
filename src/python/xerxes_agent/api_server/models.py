...
Example:
    >>> from xerxes_agent.api_server.models import ModelInfo, ModelsResponse
...
class ModelInfo(BaseModel):
    ...
    Example:
        >>> from xerxes_agent.api_server.models import ModelInfo
...
class HealthResponse(BaseModel):
    ...
    Example:
        >>> from xerxes_agent.api_server.models import HealthResponse
