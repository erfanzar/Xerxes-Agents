...
class Cortex:
    ...
    Example:
        >>> from xerxes_agent.cortex import Cortex, CortexAgent, CortexTask, ProcessType
        >>> from xerxes_agent.llms import OpenAILLM
        >>>
        >>> llm = OpenAILLM(api_key="your-key")
        >>> writer = CortexAgent(
    ...
    def kickoff(
        ...
        if log_process and stream_callback is None:
            from xerxes_agent.logging.console import stream_callback as default_stream_callback
    ...
    def from_task_creator(
        ...
        Example:
            >>> from xerxes_agent.cortex import Cortex, CortexTask, TaskCreator
