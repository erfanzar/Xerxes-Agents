...
from xerxes_agent.memory.compat import MemoryType
...
class DynamicCortex(Cortex):
    ...
    def __init__(
        ...
        Args:
            ...
            reinvoke_after_function: Whether to reinvoke LLM after tool calls.
                Defaults to True.
            enable_xerxes_memory: Whether to enable Xerxes-level memory.
                Defaults to False.
    ...
    def create_ui(self):
        ...
        Note:
            Requires the xerxes_agent.ui module to be available. The UI runs
