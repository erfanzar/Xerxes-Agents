...
from xerxes_agent.types.function_execution_types import Completion, ResponseResult, StreamingResponseType
from xerxes_agent.types.tool_calls import Tool
...
"""
    ...
    def execute(
        ...
        try:
            ...
            if self._auto_compact_agent and self._messages_history:
                from xerxes_agent.types.messages import UserMessage
            ...
            if self._auto_compact_agent and self._messages_history:
                ...
                if conversation_tokens >= self._auto_compact_agent.threshold_tokens:
                    ...
                    from ..context.compaction_strategies import get_compaction_strategy
            ...
            if self._auto_compact_agent and result:
                from xerxes_agent.types.messages import AssistantMessage
    ...
    def execute_stream(
        ...
        """
        from xerxes_agent.types import StreamChunk
    ...
    def create_ui(self) -> Any:
        ...
        interact with this agent through a graphical interface.

        Returns:
            The UI application instance from xerxes_agent.ui.
        """
