...
Usage::
    ...
    from xerxes_agent.runtime.bridge import populate_registry, build_tool_executor
...
def populate_registry(
    ...
    Scans ``xerxes_agent.tools.TOOL_CATEGORIES`` and registers each available
    ...
    """
    from xerxes_agent.runtime.execution_registry import ExecutionRegistry
    from xerxes_agent.streaming.permissions import SAFE_TOOLS

    if registry is None:
        registry = ExecutionRegistry()

    try:
        import xerxes_agent.tools as tools_mod
    except ImportError:
        logger.warning("xerxes_agent.tools not available")
        return registry
    ...
    for category, tool_names in categories.items():
        ...
        for tool_name in tool_names:
            ...
            registry.register_tool(
                ...
                category=category,
                safe=is_safe,
                source_hint=f"xerxes_agent.tools.{category}",
                schema=schema,
            )
...
def create_query_engine(
    ...
    **config_kwargs: Any,
    ...
    """
    from xerxes_agent.runtime.query_engine import QueryEngine
...
def bootstrap_xerxes(
    ...
    """
    from xerxes_agent.runtime.bootstrap import bootstrap
