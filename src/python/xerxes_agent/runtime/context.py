...
Supports :class:`~xerxes_agent.runtime.profiles.PromptProfile` to control
...
class RuntimeInfo:
    ...
    def capture(cls, workspace_root: str | None = None) -> RuntimeInfo:
        ...
        Returns:
            ...
            data.
        """
        from xerxes_agent import __version__
...
class PromptContext:
    ...
    :class:`~xerxes_agent.runtime.profiles.PromptProfileConfig`.
...
class PromptContextBuilder:
    ...
    :class:`~xerxes_agent.runtime.profiles.PromptProfile` and can produce
