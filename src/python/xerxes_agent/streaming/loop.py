...
Usage::
    ...
    from xerxes_agent.streaming.events import AgentState, TextChunk, ToolStart
...
def run(
    ...
    """
    from xerxes_agent.llms.registry import detect_provider, get_provider_config
...
def _stream_llm(
    ...
    """
    from xerxes_agent.llms.registry import PROVIDERS, bare_model, detect_provider
...
def _stream_anthropic(
    ...
    from xerxes_agent.llms.registry import get_api_key
...
def _stream_openai_compat(
    ...
    from xerxes_agent.llms.registry import PROVIDERS, get_api_key
