...
for integrating Large Language Model (LLM) providers into the Xerxes framework.
...
Typical usage example:
    from xerxes_agent.llms.openai_llm import OpenAILLM
...
class BaseLLM(ABC):
    ...
    must follow within the Xerxes framework. It provides common functionality
