...
``xerxes_agent.operators.subagents``:
...
Usage::
    ...
    from xerxes_agent.agents.subagent_manager import SubAgentManager
    from xerxes_agent.agents.definitions import get_agent_definition
...
class SubAgentManager:
    ...
    def spawn(
        ...
        def _run() -> None:
            from xerxes_agent.runtime.config_context import emit_event
...
def _run_streaming_loop(
    ...
    from xerxes_agent.runtime.config_context import emit_event
    from xerxes_agent.streaming.events import AgentState, TextChunk, ThinkingChunk, ToolEnd, ToolStart
