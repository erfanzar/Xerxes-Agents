...
"""Sandbox backend implementations for Xerxes.

Provides a registry of concrete :class:`~xerxes_agent.security.sandbox.SandboxBackend`
...
def register_backend(name: str, cls: type) -> None:
    ...
    Args:
        ...
        cls: The backend class to register. It must accept a
            ...
            :class:`~xerxes_agent.security.sandbox.SandboxConfig` in its
            constructor.
    """
