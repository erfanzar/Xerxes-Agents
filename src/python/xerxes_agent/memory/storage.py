...
class FileStorage(MemoryStorage):
    ...
    Example:
        >>> from xerxes_agent.memory.storage import FileStorage
...
class SQLiteStorage(MemoryStorage):
    ...
    Example:
        ...
        >>> from xerxes_agent.memory.storage import SQLiteStorage
...
class RAGStorage(MemoryStorage):
    ...
    Example:
        >>> from xerxes_agent.memory.storage import RAGStorage, SimpleStorage
    ...
    #: Storage-key prefix used for persisted embedding vectors.
    ...
    def __init__(
        ...
        Args:
            ...
            embedding_api_key: API key for OpenAI embeddings. Falls back
                ...
                provided.
            embedder: Optional pre-built :class:`~xerxes_agent.memory.embedders.Embedder`.
    ...
    def _compute_embedding(self, text: str) -> list[float]:
        ...
        When an explicit :class:`~xerxes_agent.memory.embedders.Embedder` was passed
