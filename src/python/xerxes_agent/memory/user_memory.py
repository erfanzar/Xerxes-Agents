...
class UserMemory:
    ...
    Attributes:
        storage: Optional :class:`~xerxes_agent.memory.storage.MemoryStorage`
    ...
    Example:
        >>> from xerxes_agent.memory import UserMemory
        >>> um = UserMemory()
    ...
    def save_memory(self, user_id: str, content: str, metadata: dict[str, Any] | None = None, **kwargs):
        ...
        Returns:
            The :class:`~xerxes_agent.memory.base.MemoryItem` created by the
    ...
    def search_user_memory(self, user_id: str, query: str, limit: int = 10, **kwargs) -> list:
        ...
        Returns:
            List of matching :class:`~xerxes_agent.memory.base.MemoryItem`
