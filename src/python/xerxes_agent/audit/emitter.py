...
:class:`AuditEmitter` wraps an :class:`~xerxes_agent.audit.collector.AuditCollector`
and exposes one dedicated ``emit_*`` method for every event type defined in
:mod:`xerxes_agent.audit.events`. This keeps call-sites in the executor and
...
Example:
    ::
        ...
        from xerxes_agent.audit import AuditEmitter, InMemoryCollector
...
class AuditEmitter:
    ...
    def flush(self) -> None:
        ...
        :meth:`~xerxes_agent.audit.collector.AuditCollector.flush` method,
