...
try:
    ...
    class XerxesTimeoutError(Exception):  # type: ignore[no-redef]
...
class EnhancedFunctionExecutor:
    ...
    async def execute_with_timeout(
        ...
        Raises:
            XerxesTimeoutError: If execution exceeds the timeout.
    ...
    async def execute_with_retry(
        ...
        Raises:
            XerxesTimeoutError: Propagated immediately without retrying.
