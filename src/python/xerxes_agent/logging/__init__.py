...
"""Logging subsystem for Xerxes.

This package provides two complementary logging modules for the Xerxes framework:
...
Example:
    >>> from xerxes_agent.logging import get_logger, log_step, set_verbosity
    >>> set_verbosity("DEBUG")
    >>> logger = get_logger()
