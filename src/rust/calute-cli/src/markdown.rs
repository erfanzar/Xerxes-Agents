...
//!
//! Uses [`pulldown_cmark`] to parse markdown and produces styled
//! [`ratatui::text::Line`] vectors with headings, code blocks,
        ...
        match event {
            ...
            MdEvent::Text(text) => {
                if in_code_block {
                    ...
                    // Push text as-is to preserve whitespace around bold/italic.
                    // Line breaking is handled by prewrap_lines in render.rs.
