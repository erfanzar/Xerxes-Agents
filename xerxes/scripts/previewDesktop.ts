...
const child=Bun.spawn([root+'/node_modules/electron/dist/Electron.app/Contents/MacOS/Electron',out+'/main.cjs'],{stdout:Bun.file(out+'/stdout.log'),stderr:Bun.file(out+'/stderr.log')})
