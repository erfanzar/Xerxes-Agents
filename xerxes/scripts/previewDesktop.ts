...
const child=Bun.spawn([root+'/node_modules/electron/dist/Electron.app/Contents/MacOS/Electron',verifyMonitor?root+'/xerxes/test/fixtures/desktop/workMonitorVerification.cjs':out+'/main.cjs'],{env:{...Bun.env,XERXES_QA_ROOT:out},stdout:Bun.file(out+'/stdout.log'),stderr:Bun.file(out+'/stderr.log')})
