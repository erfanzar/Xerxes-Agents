...
### Using Venue-Owned LaTeX Templates

Xerxes does not redistribute conference templates. Download the current archive from the
venue before each submission; format rules, filenames, page limits, and licenses change by
year and track.

| Venue | Official template and author instructions |
|-------|-------------------------------------------|
| NeurIPS 2025 | [NeurIPS 2025 Call for Papers and formatting instructions](https://neurips.cc/Conferences/2025/CallForPapers) |
| ICML 2026 | [ICML 2026 Author Instructions](https://icml.cc/Conferences/2026/AuthorInstructions) |
| ICLR 2026 | [ICLR 2026 Author Guide](https://iclr.cc/Conferences/2026/AuthorGuide) |
| ACL venues | [ACL official style-file repository](https://github.com/acl-org/acl-style-files) |
| AAAI-26 | [AAAI-26 Submission Instructions and Author Kit](https://aaai.org/conference/aaai/aaai-26/submission-instructions/) |
| COLM | [COLM official template repository](https://github.com/COLM-org/Template) |

Template setup checklist:

- [ ] Download the archive from the official venue or venue-owned repository.
- [ ] Read the current author instructions for the exact year and track.
- [ ] Preserve the archive and its license or usage notice alongside the working copy.
- [ ] Extract the complete archive; do not copy only the main `.tex` file.
- [ ] Compile the untouched example before making changes.
- [ ] Never modify venue-owned `.sty` or `.bst` files unless the venue explicitly permits it.
- [ ] Replace example content section by section and compile after each section.
- [ ] Re-check the official instructions immediately before submission.

Before making any changes, run the compilation command specified by the downloaded template.
If the venue does not specify one, `latexmk -pdf <main-file>.tex` is a common starting point.
Keep example content available as a formatting reference, but write the paper in a separate
working copy so an updated official archive can be compared cleanly.

### Template Pitfalls

| Pitfall | Problem | Solution |
|---------|---------|----------|
| Using a cached prior-year template | Rules and macros may have changed | Download from the current official venue page |
| Copying only `.tex` | Required styles and bibliography files are missing | Extract the complete official archive |
| Modifying `.sty` or `.bst` | Can violate venue rules | Treat venue-owned files as read-only |
| Assuming one track's page limit | Tracks may differ | Verify the exact current author instructions |
| Adding packages blindly | Conflicts with venue styles | Check the official preamble first |
...
```bash
# 1. Download the current target-venue archive from its official source.
# 2. Extract the complete archive into a fresh working directory.
unzip venue-template.zip -d new_submission/

# 3. Copy ONLY content sections (not preamble)
#    - Abstract text, section content, figures, tables, bib entries

# 4. Adjust for the current page limits
# 5. Add venue-specific required sections
# 6. Update references
```
...
## Xerxes Agent Integration

This skill is designed for the Xerxes agent. It uses Xerxes tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Xerxes skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `~/xerxes-agent/plans/` | `skill_view("plan")` |
...
delegate_task("Draft the Methods section based on these experiment scripts and configs.
  ...
  reproduction. Write in LaTeX using the current official NeurIPS template conventions.")
...
Conference templates are not bundled. Acquire the current files directly from the venue:

- [NeurIPS 2025](https://neurips.cc/Conferences/2025/CallForPapers)
- [ICML 2026](https://icml.cc/Conferences/2026/AuthorInstructions)
- [ICLR 2026](https://iclr.cc/Conferences/2026/AuthorGuide)
- [ACL official style files](https://github.com/acl-org/acl-style-files)
- [AAAI-26 Author Kit](https://aaai.org/conference/aaai/aaai-26/submission-instructions/)
- [COLM official template](https://github.com/COLM-org/Template)

Keep the downloaded archive's license or usage notice with the paper workspace and verify the
venue's current rules before submission.
...
**Venues:** [NeurIPS 2025](https://neurips.cc/Conferences/2025/CallForPapers) | [ICML](https://icml.cc/Conferences/2026/AuthorInstructions) | [ICLR](https://iclr.cc/Conferences/2026/AuthorGuide) | [ACL](https://github.com/acl-org/acl-style-files) | [AAAI](https://aaai.org/conference/aaai/aaai-26/submission-instructions/) | [COLM](https://github.com/COLM-org/Template)
