...
export function buildCompactionPromptFromText(options: CompactionPromptOptions): string {
  ...
  return [
    ...
    'transcript below into a concise working record for the next turn. Preserve the information',
    'needed to continue accurately without rereading the original transcript.',
    '',
    ...
    '',
    'Write only the final summary. Do not emit a scratchpad, analysis block, or preamble.',
    'Spend the available output budget on the durable record of the task and its evidence.',
    '',
    'WRITE THE SUMMARY, USING EXACTLY THESE SECTIONS',
    '',
    '## User requests',
    'Preserve unresolved user requests, corrections and standing constraints. Quote their operative',
    'wording. Group completed requests and repeated continuation prompts instead of repeating each',
    'historical turn. Distinguish completed, deferred and refused work; do not imply completion.',
    '',
    '## Current task',
